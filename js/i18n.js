class I18nManager {
    ...
    getFallbackTranslations() {
        return {
            ...
            "location.permission.error": "Could not get location",
            "location.map.click": "Click on map to select location",
            ...
            if (translation !== key) {
                ...
                if (el.classList.contains('filter-text') || 
                    ...
                    if (filterTextSpan) {
                        ...
                        // Fallback for buttons without proper structure
                        el.textContent = translation;
                    }
                } else {
                    // Normal text content update for non-filter elements
                    el.textContent = translation;
                }
            }
        });
